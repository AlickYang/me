            ...
            <div className="group">
                <Card media={media} header={header} effects={""}>
                    <button onClick={onActiveHandler}>
                        {isActive ? <IoIosArrowDropdown className="animate-bounce mx-auto text-xl transform:rotateX(180deg)" /> : <IoIosArrowDropdown className="animate-bounce mx-auto text-xl" />}
                    </button>
